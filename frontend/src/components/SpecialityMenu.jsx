...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Find by Specialised Category </h1>
            <p className='sm:w-1/3 text-center text-sm'>Explore our comprehensive list of trusted doctors based on their expertise field and effortlessly schedule your appointment.</p>
